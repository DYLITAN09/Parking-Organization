		...
		<!-- Área Principal -->
		<div class="section-pg row row row-cols-1 row-cols-sm-2 justify-content-center bg-light">			
				<div class="col px-2 pt-2 pr-sm-0">
					<div class="card h-100">
						<!-- <img src="..." class="card-img-top" alt="..."> -->
						<div class="card-header bg-secondary">
							<h5 class="card-title m-0 text-white">Módulo Usuarios</h5>					    	
					  	</div>
						<div class="card-body">
				...
				<div class="col px-2 pt-2">
					<div class="card h-100">
						<!-- <img src="..." class="card-img-top" alt="..."> -->
						<div class="card-header bg-secondary">
							<h5 class="card-title m-0 text-white">Módulo Principal</h5>					    	
					  	</div>
						<div class="card-body">							
							<ul class="list-group list-group-flush">
				...
				<div class="col px-2 pt-2 pr-sm-0">
					<div class="card h-100">
						<!-- <img src="..." class="card-img-top" alt="..."> -->
						<div class="card-header bg-secondary">
							<h5 class="card-title m-0 text-white">Módulo Secundario</h5>					    	
					  	</div>
						<div class="card-body">							
							<ul class="list-group list-group-flush">
							  <li class="list-group-item"><a href="../5_others/error404.html" class="card-link">Crear Caso de uso</a></li>
				...
				<div class="col px-2 pt-2">
					<div class="card h-100">
						<!-- <img src="..." class="card-img-top" alt="..."> -->
						<div class="card-header bg-secondary">
							<h5 class="card-title m-0 text-white">Módulo Reportes</h5>					    	
					  	</div>
						<div class="card-body">							
							<ul class="list-group list-group-flush">
