                   ...
                   <i class="fas fa-minus-square fa-spin"></i>
					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						...
						<ul class="navbar-nav">							
							...
							<li class="nav-item">
								<a class="nav-link text-white ocul-navbar" href="view/modules/7_others/calendario.html" target="area_trabajo">Calendario</a>
							</li>
							<li class="nav-item">
								...
								<div class="card-body p-lg-1">
									<div class="card">
										<ul class="list-group list-group-flush">
											...
											<li class="list-group-item p-0 bg-light">
												<a href="?c=Users&a=read" class="card-link d-block p-2 px-lg-3 py-lg-1 ocul-aside">Consultar Usuarios</a>
											</li>
                                            <li class="list-group-item p-0 bg-light">
                                        <a href="?c=Users&a=read" target="area_trabajo" class="card-link d-block p-2 px-lg-3 py-lg-1 ocul-aside">Actualizar Usuario</a>
                                            </li>
                                         <li class="list-group-item p-0 bg-light">
                                        <a href="?c=Users&a=read" target="area_trabajo" class="card-link d-block p-2 px-lg-3 py-lg-1 ocul-aside">Eliminar Usuario</a>
                                            </li>
										</ul>
									</div>
								</div>
